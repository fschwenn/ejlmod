...
jnlfilename = 'THESES-WashingtonUSeattle-%s' % (stampoftoday)
...
for page in range(pages):
    tocurl = 'https://digital.lib.washington.edu/researchworks/handle/1773/4956/browse?order=DESC&rpp=' + str(rpp) + '&sort_by=3&etal=-1&offset=' + str(page*rpp) + '&type=dateissued'
    ...
    for div in divs:
        ...
        for a in div.find_all('a'):
            rec['artlink'] = 'https://digital.lib.washington.edu' + a['href'] #+ '?show=full'
